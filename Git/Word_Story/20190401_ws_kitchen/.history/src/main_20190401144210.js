...
class playGame extends Phaser.Scene {
    ...
    glasses(){
        ...
        // }, 300);
        var letters = ['y','e','e',]
        this.showWords(letters,{name:'words',x:256,y:580},'eye')
    }
    cinah(){
        ...
        var letters = ['n','c','e','k']
        this.showWords(letters,{name:'words',x:256,y:580},'neck') 
        // setTimeout(() => {
    ...
    showHand(){
        ...
        if(hand_arr.length == 0){
            this.hand.x = words_bg.x
            this.hand.y = words_bg.y+50
        }
        if(hand_arr[hand_arr.length-1] == 't'){
            this.hand.x = words_bg.x-80
            this.hand.y = words_bg.y+50
        }
        if(hand_arr[hand_arr.length-1] == 'a'){
            this.hand.x = words_bg.x+80
            this.hand.y = words_bg.y+50
        }
