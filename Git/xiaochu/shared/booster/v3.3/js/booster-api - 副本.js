(function () {
    ...
    (function (global) {
        ...
        function newContext(e) {
            ...
            function w(e, t, n, i) {
                ...
                return e || (v = !1, e = "_@r" + (p += 1)), a = b(e), f = a[0], e = a[1], f && (f = m(f, l, i), o = getOwn(c, f)), e && (f ? o && o.normalize ? g = o.normalize(e, function (e) {
                    ...
                    prefix: f, name: g, parentMap: t, unnormalized: !!u, url: s, originalName: h, isDefine: v,
                    id: (f ? f + "!" + g : g) + u
                }
            }
            ...
            function k() {
                var e, n, i, u, f = o.waitSeconds * 1e3, l = f && r.startTime + f < (new Date).getTime(), c = [],
                    h = [], p = !1, d = !0;
                if (t) return;
                t = !0, eachProp(a, function (t) {
                    ...
                    if (!t.enabled) return;
                    e.isDefine || h.push(t);
                    if (!t.error) if (!t.inited && l) y(n) ? (u = !0, p = !0) : (c.push(n), g(n)); else if (!t.inited && t.fetched && e.isDefine) {
                        p = !0;
            ...
            var t, n, r, i, s, o = {waitSeconds: 7, baseUrl: "./", paths: {}, pkgs: {}, shim: {}, config: {}}, u = {},
                a = {}, f = {}, l = [], c = {}, h = {}, p = 1, d = 1;
            return i = {
                require: function (e) {
                ...
                init: function (e, t, n, r) {
                    ...
                    this.depMaps.push(n), S(n, "defined", bind(this, function (n) {
                        var i, s, a, f = this.map.name, l = this.map.parentMap ? this.map.parentMap.name : null,
                            c = r.makeRequire(e.parentMap, {enableBuildCallback: !0});
                ...
                config: o, contextName: e, registry: u, defined: c, urlFetched: h, defQueue: l, Module: n,
                makeModuleMap: w, nextTick: req.nextTick, onError: x, configure: function (e) {
        ...
        var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath,
            version = "2.1.9", commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
    ...
    var Zepto = function () {
        ...
        var e, t, n, r, i = [], s = i.slice, o = i.filter, u = window.document, a = {}, f = {},
            ...
            E = /complete|loaded|interactive/, S = /^\.([\w-]+)$/, x = /^#([\w-]*)$/, T = /^[\w-]*$/, N = {},
            C = N.toString, k = {}, L, A, O = u.createElement("div"), M = {
        ...
        return k.matches = function (e, t) {
            ...
            forEach: i.forEach, reduce: i.reduce, push: i.push, sort: i.sort, indexOf: i.indexOf, concat: i.concat,
            map: function (e) {
                ...
                if (e) return this.each(function (t) {
                    var r = n(this), i = K(this, e, t, r.offset()), s = r.offsetParent().offset(),
                ...
                return {
                    left: t.left + window.pageXOffset, top: t.top + window.pageYOffset, width: Math.round(t.width),
    ...
    window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto), function (e) {
        ...
        var t = e.zepto.qsa, n = 1, r, i = Array.prototype.slice, s = e.isFunction, o = function (e) {
            ...
            }, u = {}, a = {}, f = "onfocusin" in window, l = {focus: "focusin", blur: "focusout"},
        ...
        function parseArguments(e, t, n, r) {
            var i = !$.isFunction(t);
            return {
                url: e, data: i ? t : undefined, success: i ? $.isFunction(n) ? n : undefined : t,
                dataType: i ? r || n : n
            }
        }
        ...
        $.active = 0, $.ajaxJSONP = function (e, t) {
            ...
            type: "GET", beforeSend: empty, success: empty, error: empty, complete: empty, context: null, global: !0,
            xhr: function () {
                return new window.XMLHttpRequest
            }, accepts: {
                script: "text/javascript, application/javascript, application/x-javascript", json: jsonType,
                xml: "application/xml, text/xml", html: htmlType, text: "text/plain"
        ...
        var e = this, t = e._, n = {}, r = Array.prototype, i = Object.prototype, s = Function.prototype, o = r.push,
            ...
            d = r.reduceRight, v = r.filter, m = r.every, g = r.some, y = r.indexOf, b = r.lastIndexOf,
            w = Array.isArray, E = Object.keys, S = s.bind, x = function (e) {
        ...
        n.extend(m.prototype, f, {
            model: d, initialize: function () {
                ...
                var i, s, o, u, a, f, l, c = t.at, h = this.model, p = this.comparator && c == null && t.sort !== !1,
                    v = n.isString(this.comparator) ? this.comparator : null, m = [], y = [], b = {}, w = t.add,
                    E = t.merge, S = t.remove, x = !p && w && S ? [] : !1;
                for (i = 0, s = e.length; i < s; i++) {
        ...
        var t = e.extend({
            initialize: function () {
                ...
                var n = Zepto("#booster-orientation-screen-" + t).css("background-image"), r = n.split("url("),
                    i = r[1].split("images"), s = i[0] + "images/" + e;
                Zepto("#booster-orientation-screen-" + t).css("background-image", "url('" + s + "')")
            }, changeSplashImage: function (e) {
                var t = Zepto("#splash-logo").css("background-image"), n = t.split("url("), r = n[1].split("images"),
                    i = r[0] + "images/" + e;
        ...
        define("text", [], function () {
            ...
            return typeof window != "undefined" && window.navigator && window.document ? f = function (e, t) {
                ...
                var n = new java.io.File(e), r = java.lang.System.getProperty("line.separator"),
                ...
                version: "0.27.0", strip: function (e) {
                    if (e) {
                    ...
                    var t = !1, n = e.indexOf("."), r = e.substring(0, n), e = e.substring(n + 1, e.length),
                        n = e.indexOf("!");
                    ...
                    var t = a.parseName(t), s = t.moduleName + "." + t.ext,
        ...
        var s = new r, o = n.View.extend({
            orientation: "portrait", minimalUI: !1, rotationImage: "rotate.png", initialize: function (e) {
        ...
        var s = new r, o = n.View.extend({
            splashImage: "BoosterMedia320x115.png", el: "body", events: {
                "oanimationend #booster-splash": "splashFinshed", "animationend #booster-splash": "splashFinshed",
        ...
        var i = n.View.extend({
            el: "body", extendZepto: null, initialize: function () {
        ...
        var u = n.extend({
            orientation: "both", splash: !0, minimalUI: !1, rotationImage: "rotate.png",
            splashImage: "BoosterMedia320x115.png", initialize: function (e) {
                ...
                this.orientation != "both" && (t.isMobile() || t.isIPad()) && new i({
                    orientation: this.orientation, minimalUI: this.minimalUI, rotationImage: this.rotationImage
                })
            }
        });
        return u
        ...
        var i = ["UA-34318136-1"], s = n.Model.extend({
            HONEY_TRACKS_API_ID: "cf7ef2ac9fbe4a82b2f2fbcb3232ec36a4893f94", firstMenuLoad: !0, gameId: 0, name: "",
            developer: "", category: "", sessionId: "unkown", initialize: function (t) {
                ...
                s.type = "text/javascript", s.async = !0, s.src = (document.location.protocol == "https:" ? "https://ssltracker" : "http://tracker") + ".honeytracks.com/Api/Javascript/v1.3/HoneyTracks_Tracker_Library.js";
                var r = e("script").get(0);
                ...
                var s = new r, o = String(s.getURLParameter("bm.source"));
                ...
                window._HoneyTracksSDKConfig = window._HoneyTracksSDKConfig || {
                    _ApiKey: this.HONEY_TRACKS_API_ID, Language: "en_US",
    ...
    (function (e, t, n) {
        ...
        var i = {
            ...
            }, _data: {}, _CHARS: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
            _random: function () {
                var e = [];
        ...
        i.hash = {
            send: function (t, n) {
                ...
                var h = {"x-requested-with": "postmessage", source: {name: o, url: u}, postmessage: n},
            ...
            defaults: {
                target: null, url: null, type: null, data: null, success: null, error: null, origin: "*", hash: !1
            }
        })
        ...
        var o = n.View.extend({
            el: "body", initialize: function (e) {
                ...
                var t = new s;
                pm({
                    target: window.frames["booster-community-tab"], url: t.addHTTP(t.getURLParameter("bm.source")),
                    type: "open-menu"
                })
            }, render: function (n) {
        ...
        var t = e.Model.extend({
            defaults: {score: 0}, initialize: function () {
            }, submit: function (e) {
        ...
        var n = e.extend({
            setCookie: function (e, t, n) {
                ...
                var r = new t, i = window.location.origin + "/shared/booster/yahoo-timeapi/yahootime.php",
        ...
        var a = n.View.extend({
            callback: new Function, initialize: function (e) {
                ...
                this._close(), pm({target: window.frames["booster-highscore-popup"], type: "refreshHighscorePage"})
            }, submitSession: function (e) {
                var t = new u, n = t.getCookie("sessionData_" + e.bmGameId);
                n || (n = t.getCookie("sessionData"));
                var r = n ? JSON.parse(n) : {}, i = 0;
                ...
                t.setHighscoreCookie("sessionData_" + e.bmGameId, JSON.stringify(r)), this.submit({
                    score: i, bmGameId: e.bmGameId, callback: e.callback
                })
            }, submit: function (e) {
                ...
                this.callback = t.callback, e("iframe#booster-highscore-popup").removeClass("hide"), pm({
                    target: window.frames["booster-highscore-popup"], url: r.addHTTP(r.getURLParameter("bm.source")),
                    type: "open-highscore", data: {highscore: n, bmGameId: t.bmGameId}, success: function (e) {
                        console.log(e)
                    }, error: function (e) {
                        console.log(e)
                    }
        ...
        var f = n.View.extend({
            TOTAL_NR_OF_POSITIONS: 18, el: "body",
            events: {"touchend #booster-tab": "_click", "touchend #booster-tab-logo": "_click"}, community: {},
            highscore: {}, isOpen: !1, position: 0, bmGameId: 0, side: "left", menuIcon: undefined, clicked: !1,
            hasId: !1, initialize: function (t) {
                ...
                e("#booster-tab").removeClass("hide"), e("#booster-tab-logo").removeClass("hide"), pm({
                    target: window.frames["booster-community-tab"], type: "content-pos",
                    data: {position: "content-" + this.side, top: t}, error: function (e) {
                        console.log(e)
                    }
                })
            }, _open: function () {
                ...
                if (this.menuIcon != undefined) var n = t.template(u, {
                    side: this.side, baseURL: window.bb_base_path, icon: this.menuIcon
                }); else var n = t.template(o, {side: this.side});
                e("body").append(n), 0, e("#booster-tab-logo").css("top", this.getPosition() + "%"), e("#booster-tab").css("top", this.getPosition() + "%"), e("#booster-tab").addClass("hide"), e("#booster-tab-logo").addClass("hide"), this.community = new i({bmGameId: this.bmGameId}), this.highscore = new s({bmGameId: this.bmGameId})
            }, submitScore: function (e) {
                this.hasId ? this.highscore.submit({
                    score: e.score, bmGameId: this.bmGameId, callback: e.callback
                }) : e.callback != undefined && e.callback.call()
            }, submitSessionScore: function (e) {
                this.hasId ? this.highscore.submitSession({
                    level: e.level, score: e.score, bmGameId: this.bmGameId, callback: e.callback
                }) : e.callback != undefined && e.callback.call()
            }
        });
        return f
    }), function (e) {
        var t = "Close", n = "BeforeClose", r = "AfterClose", i = "BeforeAppend", s = "MarkupParse", o = "Open",
            u = "Change", a = "mfp", f = "." + a, l = "mfp-ready", c = "mfp-removing", h = "mfp-prevent-close", p,
            d = function () {
        ...
        d.prototype = {
            constructor: d, init: function () {
                ...
                N("BeforeOpen"), p.st.showCloseBtn && (p.st.closeBtnInside ? (x(s, function (e, t, n, r) {
                    ...
                    overflow: p.st.overflowY, overflowX: "hidden", overflowY: p.st.overflowY
                }) : p.wrap.css({
                    top: g.scrollTop(), position: "absolute"
                }), (p.st.fixedBgPos === !1 || p.st.fixedBgPos === "auto" && !p.fixedContentPos) && p.bgOverlay.css({
                    height: b.height(), position: "absolute"
            ...
            instance: null, proto: d.prototype, modules: [], open: function (t, n) {
                ...
                disableOn: 0, key: null, midClick: !1, mainClass: "", preloader: !0, focus: "", closeOnContentClick: !1,
                closeOnBgClick: !0, closeBtnInside: !0, showCloseBtn: !0, enableEscapeKey: !0, modal: !1, alignTop: !1,
                removalDelay: 0, prependTo: null, fixedContentPos: "auto", fixedBgPos: "auto", overflowY: "auto",
                closeMarkup: '<button title="%title%" type="button" class="mfp-close">&times;</button>',
                tClose: "Close (Esc)", tLoading: "Loading..."
            }
            ...
            } else p.isOpen && p[t].apply(p, Array.prototype.slice.call(arguments, 1)); else t = e.extend(!0, {}, t), v ? n.data("magnificPopup", t) : n[0].magnificPopup = t, p.addGroup(n, t);
            return n
        };
            ...
            options: {
                ...
                initImage: function () {
                    ...
                    return p._parseMarkup(n, {
                        title: I(t), img_replaceWith: t.img
                ...
                initZoom: function () {
                    ...
                    var s = e.duration, o = function (t) {
                        var n = t.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                            r = "all " + e.duration / 1e3 + "s " + e.easing, i = {
                    ...
                    var r = n.offset(), i = parseInt(n.css("padding-top"), 10),
        ...
        e.magnificPopup.registerModule("gallery", {
            options: {
                ...
                preload: [0, 2], navigateByImgClick: !0, arrows: !0, tPrev: "Previous (Left arrow key)",
                tNext: "Next (Right arrow key)", tCounter: "%curr% of %total%"
            }, proto: {
                initGallery: function () {
                    ...
                    var e = p.st.gallery.preload, t = Math.min(e[0], p.items.length),
                        n = Math.min(e[1], p.items.length), r;
        ...
        var t = 0, n = e.Model.extend({
            defaults: {interval: 0, startDate: 0}, initialize: function () {
        ...
        var n, r, i, s, o, u, a, f = e.Model.extend({
            defaults: {ad_client: "ca-games-pub-7203084817284772"}, initialize: function () {
        ...
        var c, h, p = new l, d = n.View.extend({
            type: "interstitial", size: "100x100", site: 0, zone: 0, interval: 6e4, channelID: 0, overlay: !0,
            callback: new Function, initialize: function (e) {
                ...
                window.onAdDisplay();
                if (p.getURLParameter("bm.source") != "null" && p.getURLParameter("bm.gameid") != "null") e("iframe#booster-advertisement-popup").removeClass("hide"); else {
                    var t = this;
                    e(".interstitial-popup").magnificPopup({
                        type: "inline", mainClass: "mfp-fade", closeBtnInside: !1, closeOnBgClick: !1,
                        removalDelay: 160, preloader: !1, verticalFit: !1, fixedContentPos: !1, showCloseBtn: !1,
                        callbacks: {
                            afterClose: function () {
                ...
                var l, c = p.addHTTP(p.getURLParameter("bm.source")), h = p.getURLParameter("bm.gameid"),
                    d = t.template(s, {width: r, height: i, site: o, zone: u});
                p.getURLParameter("bm.source") != "null" && p.getURLParameter("bm.gameid") != "null" ? l = t.template(f, {
                    source: c, bmGameId: h, bmChannelId: this.channelID
                }) : l = t.template(a, {width: r, height: i});
                switch (n) {
                    case"interstitial":
                        e("body").append(d);
                        break;
        ...
        var r = e.Model.extend({
            initialize: function () {
                ...
                window.onMoreGames(), n === "null" ? (n = "www.gamesplaza.com", window.top.location = e.addHTTP(n)) : window.top.location = e.addHTTP(n)
            }
        });
        return r
    }), require.config({
        paths: {
            zepto: "../lib/zepto", underscore: "../lib/underscore", backbone: "../lib/backbone",
            postmessage: "../lib/postmessage", magnificpopup: "../lib/magnificpopup", templates: "../templates"
        }, shim: {magnificpopup: ["zepto"]}
